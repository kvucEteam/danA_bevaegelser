...
function init() {
    ...
    for (var i = 0; i < JsonObj.quizdata.length; i++) {
        console.log("i:" + i);
        $(".inner_container").append("<div class ='sortable_container " + i + " icon_undefined'><div class='sortable_text_container'><p>" + JsonObj.quizdata[i].tekst + "</p></div><div class='icon_container'></div></div>");
    }
    console.log(JsonObj);
...
function next_level() {
    ...
    $('.icon_container').each(function() {
        $(this).append("<div class='btn-icon btn-icon_heli'> <img class='img_heli' src='img/helicopter.svg' >KLIK</div><div class='btn-icon btn-icon_magnify'> <img class='img_magnify' src='img/zoom-in-solid.svg' >KLIK</div>")
    });
